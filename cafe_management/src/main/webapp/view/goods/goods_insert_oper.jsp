...
<link rel="stylesheet" href="../../resources/css/goods/goods_insert.css" />
...
<body>
	...
	<div class="contents">
		<div class="inner">
			<div class="insert_title">
				<p class="title_text">상품 등록</p>
			</div>
			<div class="form_area">
				<form method='post' name="gForm" action="${pageContext.request.contextPath}/view/goods/goods_insert_oper.do"
					...
					<div class="goods_insert_button">
						<button class="btn_insert">등록</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script src="../../resources/js/common/jquery-3.3.1.min.js">
    </script>
	<script>
